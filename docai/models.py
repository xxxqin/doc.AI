...
class Block(CoreModel):
    """块模型"""
    type = models.CharField(max_length=120, null=True, blank=True, verbose_name="类型", help_text="类型") # text, image, head, image_gen
    data = models.JSONField(null=True, blank=True, verbose_name="数据", help_text="数据")
    # data数据结构 {"text": "msg"}  标题块和文本块：msg为文本内容， 图片块：msg为图片地址
