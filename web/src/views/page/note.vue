  ...
  <div class="page-container">
    ...
    <div class="page-body">
      <div class="body-top">
        ...
        <input class="title" placeholder="输入标题" v-model="pageData.title"  @input="chgPageBlur" @keydown.enter="chgPageBlur"  />
      </div>
      ...
      <div class="item" v-for="(block, index) in blocks" :key="index">
        ...
        <block
          class="block"
          v-if="block.type == 'head' || block.type == 'text'"
          :type="block.type"
          :id="block.id"
          :data="block.data"
        ></block>
...
export default {
  ...
  methods: {
    ...
    chgPageBlur() {
      ...
      this.$store.dispatch("page/note/fetchUpdatePage", data);
    },
