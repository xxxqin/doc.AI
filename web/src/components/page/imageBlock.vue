  ...
  <div class="image-viewer" ref="imageViewer">
    ...
    >
      <div class="image-inner">
        <img ref="image" class="image" :src="pic_url" />
        <div
    ...
    <el-upload
      ...
      action=""
    >
      <div class="image-upload" v-show="(!text) && blockData.type=='image'">
...
export default {
  ...
  computed: {
    ...
    pic_url() {
      let pic_url = ""
      if (this.blockData.type=='image'){
        pic_url = 'http://192.168.1.157:8000/' + this.text
      }
      return pic_url
    },
  },
